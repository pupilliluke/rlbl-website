...
\restrict ZaNldNknuaMYLXE682S8A7kj6h4LGKp3zsmFwbdWXGni9buen4tzdn1nWwhbcMe
...
DROP DATABASE IF EXISTS rlbl;
--
-- TOC entry 5043 (class 1262 OID 16417)
-- Name: rlbl; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE rlbl WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_United States.1252';


ALTER DATABASE rlbl OWNER TO postgres;

\unrestrict ZaNldNknuaMYLXE682S8A7kj6h4LGKp3zsmFwbdWXGni9buen4tzdn1nWwhbcMe
\connect rlbl
\restrict ZaNldNknuaMYLXE682S8A7kj6h4LGKp3zsmFwbdWXGni9buen4tzdn1nWwhbcMe
...
ALTER TABLE public.roster_memberships OWNER TO postgres;
