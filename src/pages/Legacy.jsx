/*
Legacy page content - commented out for later use
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0f0f1a] via-[#1a1a2e] to-black text-white relative page-with-navbar">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center">
          <div className="bg-[#1f1f2e] rounded-xl p-12 border border-purple-800">
            <div className="text-6xl mb-6">🚧</div>
            <h2 className="text-3xl font-bold text-purple-400 mb-4">Coming Soon</h2>
            <p className="text-gray-300 text-lg mb-6">
              The Legacy page is currently under construction. We're working hard to bring you historical seasons, champions, and legendary performances.
            </p>
            <p className="text-gray-400">
              Check back soon for detailed stats, standings, and records from previous seasons!
            </p>
          </div>
        </div>
      </div>
